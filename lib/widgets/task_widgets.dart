...
class Task_Widget extends StatefulWidget {
  Lesson _lesson;
  Task_Widget(this._lesson, {super.key});
...
class _Task_WidgetState extends State<Task_Widget> {
  ...
  Widget build(BuildContext context) {
    bool isDone = widget._lesson.isDon;
    return Padding(
          ...
          GestureDetector(
            onTap: () {
              Navigator.of(context).push(MaterialPageRoute(
                builder: (context) => Edit_Screen(widget._lesson),
              ));
            },
            child: Container(
              width: 90,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: DecorationImage(
          image: AssetImage('images/${widget._lesson.image}.png'),
          fit: BoxFit.cover,
        ),
      ),
    );
